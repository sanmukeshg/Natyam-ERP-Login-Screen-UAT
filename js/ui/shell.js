...
export class Shell {
    ...
    paintBranch() {
        ...
        // The switcher is always shown when the school has a branch at all.
        // Hiding it for a single-branch academy removed the one place that
        // stated which branch you were working in, which is information even
